...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        executePlugin : function(name, path, customPlugin = false, optionalParams= {"proxy": false, "customPluginPath": ""}) {
            var _this    = this;
            var cm       = this.cm;
            var settings = this.settings;

            path = (customPlugin ? (optionalParams["customPluginPath"] ? optionalParams["customPluginPath"] : settings.customPluginPath ) : settings.pluginPath) + path;
