...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
                 ...
                 names='Vehicle_type',
                 title="pie chart ads for vehicle types"
                )
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        une_rec = recession_data.groupby('Vehicle_Type')[['unemployment_rate', 'Automobile_Sales' ]].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(une_rec,
                        x='Vehicle_Type,
                        y='Automobile_Sales',
                        color='unemployment_rate',
                        title='effect of unemployement rate on vehicle type and sales')
        )
        return [
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mas, x='Month', y='Automobile_Sales', title='monthly sales'))

            # Plot bar chart for average number of vehicles sold during the given year
        avr_vdata=yearly_data.groupby(['Month' , 'Vehicle_Type']).mean().reset_index()
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(
            ...
            values='Advertising_Expenditure',
            names='Vehicle_Type'
            title='total ads exp for each vehicle type in the year: {}'.format(input_year)
        ))
